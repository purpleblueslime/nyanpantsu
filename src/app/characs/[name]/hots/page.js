  ...
  return (
    <div id={'sagiri'}>
      <div className={'sagiriWrap'}>
        ...
        /
        <Link className={'sagiri'} href={`/characs/${params.name}/hots`}>
          hots
        </Link>
      </div>
      ...
      <div className={styles.erosNav}>
        <Link className={styles.navPop} href={`/characs/${params.name}`}>
          new
        </Link>
        <Link className={styles.navBlue} href={`/characs/${params.name}/hots`}>
          hots
        </Link>
      ...
      {searchParams.page <= 0 && data.length != 18 ? <></>:
        <Pagify p={`/characs/${params.name}/hots?`} sagiri={data} page={searchParams.page} />}
    </div>
  )
