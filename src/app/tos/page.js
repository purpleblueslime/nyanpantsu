...
export default function page() {
  return (
    <div id='sagiri'>
      ...
      <div className={styles.def}>tos</div>
      ...
      <div className={styles.def}>use</div>
      <div className={styles.sagiri}>
      ...
      <div className={styles.def}>copyright</div>
      <div className={styles.sagiri}>
        {`any attempt at impersonating nyanpantsu~ will result in a perma ip ban. there are no exceptions!`}
      </div>
      <div className={styles.def}>cookie(s)</div>
      <div className={styles.sagiri}>{`nyanpantsu~ use(s) 0 cookies.`}</div>
      <div className={styles.def}>ip logging</div>
      <div className={styles.sagiri}>
      ...
      <div className={styles.def}>ad(s)</div>
      <div className={styles.sagiri}>
