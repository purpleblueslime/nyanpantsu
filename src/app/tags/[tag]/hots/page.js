  ...
  return (
    <div id={'sagiri'}>
      <div className={'sagiriWrap'}>
        ...
        /
        <Link className={'sagiri'} href={`/tags/${params.tag}/hots`}>
          hots
        </Link>
      </div>
      ...
      <div className={styles.erosNav}>
        ...
        <Link className={styles.navBlue} href={`/tags/${params.tag}/hots`}>
          hots
        </Link>
        <Link className={styles.navPop} href={`/tags/${params.tag}/a_z`}>
          a_z
        </Link>
      </div> 
      ...
      {searchParams.page <= 0 && data.length != 18 ? <></>:
        <Pagify p={`/tags/${params.tag}/hots?`} sagiri={data} page={searchParams.page} />}
    </div>
  )
