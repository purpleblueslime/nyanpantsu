  ...
  return (
    <div id={'sagiri'}>
      <div className={'sagiriWrap'}>
        ...
        / eros /
        <Link className={'sagiri'} href={'/eros/a_z'}>
          a_z
        </Link>
      </div>
      ...
      <div className={styles.erosNav}>
        ...
        <Link className={styles.navPop} href={'/eros/hots'}>
          hots
        </Link>
        <Link className={styles.navBlue} href={'/eros/a_z'}>
          a_z
        </Link>
      </div> 
      ...
      {searchParams.page <= 0 && data.length != 18 ? <></>:
        <Pagify p={'/eros/a_z/?'} sagiri={data} page={searchParams.page} />}
    </div>
  )
